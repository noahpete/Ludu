...
namespace Ludu {
    ...
    VulkanDescriptorLayout::Builder& VulkanDescriptorLayout::Builder::addBinding(
        uint32_t binding,
    ...
    std::unique_ptr<VulkanDescriptorLayout> VulkanDescriptorLayout::Builder::build() const {
        return CreateScope<VulkanDescriptorLayout>(m_Device, bindings);
    }
    ...
    VulkanDescriptorWriter::VulkanDescriptorWriter(VulkanDescriptorLayout& setLayout, VulkanDescriptorPool& pool)
